...
earth_spaceport = Location("Spaceport",
                           ...
                           [Poi("Personal Spaceship",
                                "Untouched by the surrounding chaos, one ship stands pristine. Intriguingly, a number etched on its hull matches the spaceship keycard, suggesting a bond yet to be remembered. You can now use this spaceship for travel!"),
...
cafe = Location("Cafe Ditin",
                ...
                [Poi("Tables",
                     "Three skeletons seated, a chilling remnant of a time past. An empty chair poses can be seen, on which lays a business card that resonates familiarity: the same name as on our office keycard."),
                 Poi("Bar",
...
military_base = Location("Military Base",
                         ...
                         [Poi("Military Research Center",
                          ...
                          Poi("Command center",
                              "A room of eerie silence, filled with screens and computers. None seem functional. Documents around the room allude to a catastrophic war, sparked by solar flare-induced tech failures."),
                          Poi("Robot center",
                              "Not just a workshop, but a birthplace of robotic guards. Abandoned, but your eye is drawn to a peculiar object: a remote, perhaps it holds power over robotic sentinels.")
                          ],
                         None,
                         """                                                                
